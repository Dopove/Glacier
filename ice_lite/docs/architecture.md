# GLACIER Technical Specification: Mamba2 + ICE-Lite + Temporal-RAG

Authored by: **Saran S** ([@Saran-386](https://github.com/Saran-386)), Founder & CEO of **Dopove Private Limited**.
...
*   **Memory Manager:** `ice_lite` (Apache 2.0) by Dopove Private Limited
    *   `EpisodicManager` (Storage)
    *   `ContextPager` (Prompt Assembly & Pinning)
    *   `TemporalLayer` (Time-aware reranking)
