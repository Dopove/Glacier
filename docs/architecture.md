...
## 6. Visual Architecture Guides

To better understand the core concepts of GLACIER, please refer to our detailed visual architecture documents:

*   **[Visual Architecture Overview](./architecture/glacier_overview.md)**: A high-level look at Mamba's External Hippocampus.
*   **[Defeating Context Rot](./architecture/context_rot_mitigation.md)**: A visual comparison of how GLACIER solves SSM amnesia.
*   **[Multi-Tiered Memory](./architecture/memory_layers.md)**: An explanation of the 100 Billion Token Horizon.
*   **[GLACIER vs. The Competition](../competitors.md)**: A detailed breakdown of why our architecture wins against other memory systems.
